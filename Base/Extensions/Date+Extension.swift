...
extension Date {
    ...
    /// 获取当前 秒级 时间戳 - 10位
    static func tm_getCurrentTimeStamp() -> Int {
    ...
    /// 获取当前 毫秒级 时间戳 - 13位
    static func tm_getCurrentTimeMilliStamp() -> Int64 {
        let timeInterval: TimeInterval = Date().timeIntervalSince1970
    ...
    static func tm_currentDate(format: String) -> String {
    ...
    func tm_getChineseCalendar(_ type: Int) -> String {
